"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[1427],{
...
/* harmony export */ });
/* harmony import */ var _Misc_basis_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59057);
...
class _BasisTextureLoader {
    ...
    loadCubeData(data, texture, createPolynomials, onLoad, onError) {
        ...
        (0,_Misc_basis_js__WEBPACK_IMPORTED_MODULE_0__/* .TranscodeAsync */ .yk)(data, transcodeConfig)
            .then((result) => {
            const hasMipmap = result.fileInfo.images[0].levels.length > 1 && texture.generateMipMaps;
            (0,_Misc_basis_js__WEBPACK_IMPORTED_MODULE_0__/* .LoadTextureFromTranscodeResult */ .aB)(texture, result);
            ...
            _Misc_tools_js__WEBPACK_IMPORTED_MODULE_1__/* .Tools */ .S0.Warn(errorMessage);
            texture.isReady = true;
            if (onError) {
                onError(err);
            }
    ...
    loadData(data, texture, callback) {
        ...
        (0,_Misc_basis_js__WEBPACK_IMPORTED_MODULE_0__/* .TranscodeAsync */ .yk)(data, transcodeConfig)
            ...
            .catch((err) => {
            _Misc_tools_js__WEBPACK_IMPORTED_MODULE_1__/* .Tools */ .S0.Warn("Failed to transcode Basis file, transcoding may not be supported on this device");
            _Misc_tools_js__WEBPACK_IMPORTED_MODULE_1__/* .Tools */ .S0.Warn(`Failed to transcode Basis file: ${err}`);
...
__webpack_require__.d(__webpack_exports__, {
  aB: () => (/* binding */ LoadTextureFromTranscodeResult),
  yk: () => (/* binding */ TranscodeAsync)
});

// UNUSED EXPORTS: BasisFileInfo, BasisTools, BasisToolsOptions, BasisTranscodeConfiguration, GetInternalFormatFromBasisFormat, SetBasisTranscoderWorker

// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Misc/tools.js
var tools = __webpack_require__(998);
// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Materials/Textures/texture.js
var Textures_texture = __webpack_require__(7481);
// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Materials/Textures/internalTexture.js
var internalTexture = __webpack_require__(81194);
