"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[9158],{
...
/* harmony export */ });
/* harmony import */ var _Misc_khronosTextureContainer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6443);
/* harmony import */ var _Misc_khronosTextureContainer2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(77502);
/* harmony import */ var _Misc_logger_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(51137);
...
class _KTXTextureLoader {
    ...
    loadCubeData(data, texture, createPolynomials, onLoad) {
        ...
        const ktx = new _Misc_khronosTextureContainer_js__WEBPACK_IMPORTED_MODULE_0__/* .KhronosTextureContainer */ .H(data, 6);
    ...
    loadData(data, texture, callback, options) {
        if (_Misc_khronosTextureContainer_js__WEBPACK_IMPORTED_MODULE_0__/* .KhronosTextureContainer */ .H.IsValid(data)) {
            // Need to invert vScale as invertY via UNPACK_FLIP_Y_WEBGL is not supported by compressed texture
            texture._invertVScale = !texture.invertY;
            const ktx = new _Misc_khronosTextureContainer_js__WEBPACK_IMPORTED_MODULE_0__/* .KhronosTextureContainer */ .H(data, 1);
        ...
        else if (_Misc_khronosTextureContainer2_js__WEBPACK_IMPORTED_MODULE_1__/* .KhronosTextureContainer2 */ .Z.IsValid(data)) {
            const ktx2 = new _Misc_khronosTextureContainer2_js__WEBPACK_IMPORTED_MODULE_1__/* .KhronosTextureContainer2 */ .Z(texture.getEngine());
            ktx2._uploadAsync(data, texture, options).then(() => {
                callback(texture.width, texture.height, texture.generateMipMaps, true, () => { }, false);
            }, (error) => {
                _Misc_logger_js__WEBPACK_IMPORTED_MODULE_2__/* .Logger */ .V.Warn(`Failed to load KTX2 texture data: ${error.message}`);
                callback(0, 0, false, false, () => { }, true);
            });
        }
        else {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_2__/* .Logger */ .V.Error("texture missing KTX identifier");
            callback(0, 0, false, false, () => { }, true);
        }
    }
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Xl: () => (/* binding */ TranscodeTarget)
/* harmony export */ });
/* unused harmony exports SourceTextureFormat, EngineFormat */
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   H: () => (/* binding */ KhronosTextureContainer)
/* harmony export */ });
...
class KhronosTextureContainer {
    ...
    data, facesExpected) {
        ...
        if (!KhronosTextureContainer.IsValid(data)) {
            this.isInvalid = true;
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_0__/* .Logger */ .V.Error("texture missing KTX identifier");
            return;
        }
        ...
        if (this.glType !== 0) {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_0__/* .Logger */ .V.Error("only compressed formats currently supported");
            this.isInvalid = true;
            return;
        }
        else {
        ...
        if (this.pixelHeight === 0 || this.pixelDepth !== 0) {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_0__/* .Logger */ .V.Error("only 2D textures currently supported");
            this.isInvalid = true;
            return;
        }
        if (this.numberOfArrayElements !== 0) {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_0__/* .Logger */ .V.Error("texture arrays not currently supported");
            this.isInvalid = true;
            return;
        }
        if (this.numberOfFaces !== facesExpected) {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_0__/* .Logger */ .V.Error("number of faces expected" + facesExpected + ", but found " + this.numberOfFaces);
            this.isInvalid = true;
            return;
        }
...
__webpack_require__.d(__webpack_exports__, {
  Z: () => (/* binding */ KhronosTextureContainer2)
});

// UNUSED EXPORTS: DefaultKTX2DecoderOptions

// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Misc/workerPool.js
var workerPool = __webpack_require__(97573);
// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Misc/tools.js
var tools = __webpack_require__(998);
// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Materials/Textures/ktx2decoderTypes.js
var ktx2decoderTypes = __webpack_require__(60572);
    ...
    _getKTX2DecoderOptions() {
        ...
        if (this.useRGBAIfOnlyBC1BC3AvailableWhenUASTC) {
            options.transcodeFormatDecisionTree = {
                UASTC: {
                    transcodeFormat: [ktx2decoderTypes/* TranscodeTarget */.Xl.BC1_RGB, ktx2decoderTypes/* TranscodeTarget */.Xl.BC3_RGBA],
                    yes: {
                        transcodeFormat: ktx2decoderTypes/* TranscodeTarget */.Xl.RGBA32,
    ...
    static _Initialize(numWorkers) {
        ...
        if (numWorkers && typeof Worker === "function" && typeof URL !== "undefined") {
            KhronosTextureContainer2._WorkerPoolPromise = new Promise((resolve) => {
                ...
                resolve(new workerPool/* AutoReleaseWorkerPool */.h(numWorkers, () => initializeWebWorker(new Worker(workerBlobUrl), undefined, urls)));
            });
        }
        else {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   h: () => (/* binding */ AutoReleaseWorkerPool)
/* harmony export */ });
/* unused harmony export WorkerPool */
/**
