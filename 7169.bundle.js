"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[7169],{
...
/* harmony export */ });
/* harmony import */ var _Misc_tga_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(52053);
...
class _TGATextureLoader {
    ...
    loadData(data, texture, callback) {
        ...
        const header = (0,_Misc_tga_js__WEBPACK_IMPORTED_MODULE_0__/* .GetTGAHeader */ .O_)(bytes);
        callback(header.width, header.height, texture.generateMipMaps, false, () => {
            (0,_Misc_tga_js__WEBPACK_IMPORTED_MODULE_0__/* .UploadContent */ .FA)(texture, bytes);
        });
    }
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FA: () => (/* binding */ UploadContent),
/* harmony export */   O_: () => (/* binding */ GetTGAHeader)
/* harmony export */ });
/* unused harmony export TGATools */
...
function UploadContent(texture, data) {
    ...
    if (data.length < 19) {
        _Misc_logger_js__WEBPACK_IMPORTED_MODULE_0__/* .Logger */ .V.Error("Unable to load TGA file - Not enough data to contain header");
        return;
    }
    // Read Header
    let offset = 18;
    ...
    if (header.id_length + offset > data.length) {
        _Misc_logger_js__WEBPACK_IMPORTED_MODULE_0__/* .Logger */ .V.Error("Unable to load TGA file - Not enough data");
        return;
    }
