"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[417],{
...
class RenderTargetTexture extends _Materials_Textures_texture_js__WEBPACK_IMPORTED_MODULE_2__/* .Texture */ .g {
    ...
    isReadyForRendering() {
        if (!this._dumpToolsLoading) {
            ...
            Promise.all(/* import() */[__webpack_require__.e(998), __webpack_require__.e(928)]).then(__webpack_require__.bind(__webpack_require__, 89928)).then((module) => (this._dumpTools = module));
        }
...
class EffectWrapper {
    ...
    _gatherImports(useWebGPU = false, list) {
        ...
        if (useWebGPU && this._webGPUReady) {
            list.push(Promise.all([__webpack_require__.e(/* import() */ 126).then(__webpack_require__.bind(__webpack_require__, 32083))]));
        }
        else {
