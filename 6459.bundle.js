"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[6459],{
  ...
  _workers = await Promise.all(
    Array.from({ length: builder.numThreads() }, async () => {
      ...
      const worker = new Worker(
        new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(7907), __webpack_require__.b),
        {
          type: undefined
        }
      );
...
module.exports = __webpack_require__.p + "8c002c7e29091dc03639.wasm";
