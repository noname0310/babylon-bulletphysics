"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[6464],{

/***/ 69195:
/***/ ((__unused_webpack___webpack_module__, __unused_webpack___webpack_exports__, __webpack_require__) => {

/* harmony import */ var _Materials_Textures_internalTexture_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(81194);
/* harmony import */ var _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(51137);
/* harmony import */ var _Misc_fileTools_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8532);
/* harmony import */ var _Misc_guid_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(38688);
/* harmony import */ var _abstractEngine_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(32206);
/* harmony import */ var _Materials_Textures_Loaders_textureLoaderManager_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(18454);
...
_abstractEngine_js__WEBPACK_IMPORTED_MODULE_4__/* .AbstractEngine */ .$.prototype._partialLoadImg = function (url, index, loadedImages, scene, texture, onfinish, onErrorCallBack = null, mimeType) {
    const tokenPendingData = (0,_Misc_guid_js__WEBPACK_IMPORTED_MODULE_3__/* .RandomGUID */ .z)();
    const onload = (img) => {
    ...
    (0,_Misc_fileTools_js__WEBPACK_IMPORTED_MODULE_2__/* .LoadImage */ .W$)(url, onload, onerror, scene ? scene.offlineProvider : null, mimeType);
    if (scene) {
...
_abstractEngine_js__WEBPACK_IMPORTED_MODULE_4__/* .AbstractEngine */ .$.prototype.createCubeTextureBase = function (rootUrl, scene, files, noMipmap, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = false, lodScale = 0, lodOffset = 0, fallback = null, beforeLoadCubeDataCallback = null, imageHandler = null, useSRGBBuffer = false, buffer = null) {
    const texture = fallback ? fallback : new _Materials_Textures_internalTexture_js__WEBPACK_IMPORTED_MODULE_0__/* .InternalTexture */ .hV(this, 7 /* InternalTextureSource.Cube */);
    texture.isCube = true;
    texture.url = rootUrl;
    ...
    const loaderPromise = (0,_Materials_Textures_Loaders_textureLoaderManager_js__WEBPACK_IMPORTED_MODULE_5__/* ._GetCompatibleTextureLoader */ .gT)(extension);
    const onInternalError = (request, exception) => {
        if (rootUrl === originalRootUrl) {
            ...
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__/* .Logger */ .V.Warn(`Failed to load ${rootUrl}, falling back to the ${originalRootUrl}`);
            ...
            if (buffer) {
                ...
                if (loader.supportCascades) {
                    ...
                    if (onError) {
                        ...
                        _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__/* .Logger */ .V.Warn("Texture loader does not support cascades.");
                    }
                }
            }
            else {
...
/* harmony import */ var _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(51137);
/* harmony import */ var _Misc_HighDynamicRange_cubemapToSphericalPolynomial_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36755);
/* harmony import */ var _textureTools_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(42683);
/* harmony import */ var _Engines_AbstractEngine_abstractEngine_cubeTexture_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(69195);
...
class DDSTools {
    ...
    static _GetHalfFloatAsFloatRGBAArrayBuffer(width, height, dataOffset, dataLength, arrayBuffer, lod) {
        ...
        for (let y = 0; y < height; y++) {
            for (let x = 0; x < width; x++) {
                ...
                destArray[index] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .FromHalfFloat */ .SX)(srcData[srcPos]);
                destArray[index + 1] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .FromHalfFloat */ .SX)(srcData[srcPos + 1]);
                destArray[index + 2] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .FromHalfFloat */ .SX)(srcData[srcPos + 2]);
                if (DDSTools.StoreLODInAlphaChannel) {
                    destArray[index + 3] = lod;
                }
                else {
                    destArray[index + 3] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .FromHalfFloat */ .SX)(srcData[srcPos + 3]);
                }
                index += 4;
            }
        }
        ...
        if (DDSTools.StoreLODInAlphaChannel) {
            ...
            for (let y = 0; y < height; y++) {
                for (let x = 0; x < width; x++) {
                    ...
                    destArray[index + 3] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .ToHalfFloat */ .LZ)(lod);
                    index += 4;
                }
            }
            return destArray;
    ...
    static _GetFloatAsHalfFloatRGBAArrayBuffer(width, height, dataOffset, dataLength, arrayBuffer, lod) {
        ...
        for (let y = 0; y < height; y++) {
            for (let x = 0; x < width; x++) {
                destArray[index] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .ToHalfFloat */ .LZ)(srcData[index]);
                destArray[index + 1] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .ToHalfFloat */ .LZ)(srcData[index + 1]);
                destArray[index + 2] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .ToHalfFloat */ .LZ)(srcData[index + 2]);
                if (DDSTools.StoreLODInAlphaChannel) {
                    destArray[index + 3] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .ToHalfFloat */ .LZ)(lod);
                }
                else {
                    destArray[index + 3] = (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .ToHalfFloat */ .LZ)(srcData[index + 3]);
                }
                index += 4;
            }
        }
    ...
    static _GetHalfFloatAsUIntRGBAArrayBuffer(width, height, dataOffset, dataLength, arrayBuffer, lod) {
        ...
        for (let y = 0; y < height; y++) {
            for (let x = 0; x < width; x++) {
                const srcPos = (x + y * width) * 4;
                destArray[index] = (0,_Maths_math_scalar_functions_js__WEBPACK_IMPORTED_MODULE_0__.Clamp)((0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .FromHalfFloat */ .SX)(srcData[srcPos])) * 255;
                destArray[index + 1] = (0,_Maths_math_scalar_functions_js__WEBPACK_IMPORTED_MODULE_0__.Clamp)((0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .FromHalfFloat */ .SX)(srcData[srcPos + 1])) * 255;
                destArray[index + 2] = (0,_Maths_math_scalar_functions_js__WEBPACK_IMPORTED_MODULE_0__.Clamp)((0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .FromHalfFloat */ .SX)(srcData[srcPos + 2])) * 255;
                if (DDSTools.StoreLODInAlphaChannel) {
                    destArray[index + 3] = lod;
                }
                else {
                    destArray[index + 3] = (0,_Maths_math_scalar_functions_js__WEBPACK_IMPORTED_MODULE_0__.Clamp)((0,_textureTools_js__WEBPACK_IMPORTED_MODULE_3__/* .FromHalfFloat */ .SX)(srcData[srcPos + 3])) * 255;
                }
                index += 4;
            }
        }
    ...
    static UploadDDSLevels(engine, texture, data, info, loadMipmaps, faces, lodIndex = -1, currentFace, destTypeMustBeFilterable = true) {
        ...
        if (header[off_magic] !== DDS_MAGIC) {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__/* .Logger */ .V.Error("Invalid magic number in DDS header");
            return;
        }
        if (!info.isFourCC && !info.isRGB && !info.isLuminance) {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__/* .Logger */ .V.Error("Unsupported format, must contain a FourCC, RGB or LUMINANCE code");
            return;
        }
        if (info.isCompressed && !ext) {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__/* .Logger */ .V.Error("Compressed textures are not supported on this platform.");
            return;
        }
        ...
        if (info.isFourCC) {
            ...
            switch (fourCC) {
                ...
                default:
                    _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__/* .Logger */ .V.Error(["Unsupported FourCC code:", Int32ToFourCC(fourCC)]);
                    return;
            }
        }
        ...
        if (sphericalPolynomialFaces && sphericalPolynomialFaces.length > 0) {
            info.sphericalPolynomial = _Misc_HighDynamicRange_cubemapToSphericalPolynomial_js__WEBPACK_IMPORTED_MODULE_2__/* .CubeMapToSphericalPolynomialTools */ .d.ConvertCubeMapToSphericalPolynomial({
