"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[608],{
...
__webpack_require__.d(__webpack_exports__, {
  _HDRTextureLoader: () => (/* binding */ _HDRTextureLoader)
});
...
PanoramaToCubeMapTools.FACE_LEFT = [new math_vector/* Vector3 */.Pq(-1.0, -1.0, -1.0), new math_vector/* Vector3 */.Pq(1.0, -1.0, -1.0), new math_vector/* Vector3 */.Pq(-1.0, 1.0, -1.0), new math_vector/* Vector3 */.Pq(1.0, 1.0, -1.0)];
PanoramaToCubeMapTools.FACE_RIGHT = [new math_vector/* Vector3 */.Pq(1.0, -1.0, 1.0), new math_vector/* Vector3 */.Pq(-1.0, -1.0, 1.0), new math_vector/* Vector3 */.Pq(1.0, 1.0, 1.0), new math_vector/* Vector3 */.Pq(-1.0, 1.0, 1.0)];
PanoramaToCubeMapTools.FACE_FRONT = [new math_vector/* Vector3 */.Pq(1.0, -1.0, -1.0), new math_vector/* Vector3 */.Pq(1.0, -1.0, 1.0), new math_vector/* Vector3 */.Pq(1.0, 1.0, -1.0), new math_vector/* Vector3 */.Pq(1.0, 1.0, 1.0)];
PanoramaToCubeMapTools.FACE_BACK = [new math_vector/* Vector3 */.Pq(-1.0, -1.0, 1.0), new math_vector/* Vector3 */.Pq(-1.0, -1.0, -1.0), new math_vector/* Vector3 */.Pq(-1.0, 1.0, 1.0), new math_vector/* Vector3 */.Pq(-1.0, 1.0, -1.0)];
PanoramaToCubeMapTools.FACE_DOWN = [new math_vector/* Vector3 */.Pq(1.0, 1.0, -1.0), new math_vector/* Vector3 */.Pq(1.0, 1.0, 1.0), new math_vector/* Vector3 */.Pq(-1.0, 1.0, -1.0), new math_vector/* Vector3 */.Pq(-1.0, 1.0, 1.0)];
PanoramaToCubeMapTools.FACE_UP = [new math_vector/* Vector3 */.Pq(-1.0, -1.0, -1.0), new math_vector/* Vector3 */.Pq(-1.0, -1.0, 1.0), new math_vector/* Vector3 */.Pq(1.0, -1.0, -1.0), new math_vector/* Vector3 */.Pq(1.0, -1.0, 1.0)];
