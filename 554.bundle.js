"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[554],{
...
__webpack_require__.d(__webpack_exports__, {
  p: () => (/* binding */ ImageProcessingConfiguration)
});
...
class ColorCurves {
    constructor() {
        this._dirty = true;
        this._tempColor = new math_color/* Color4 */.ov(0, 0, 0, 0);
        this._globalCurve = new math_color/* Color4 */.ov(0, 0, 0, 0);
        this._highlightsCurve = new math_color/* Color4 */.ov(0, 0, 0, 0);
        this._midtonesCurve = new math_color/* Color4 */.ov(0, 0, 0, 0);
        this._shadowsCurve = new math_color/* Color4 */.ov(0, 0, 0, 0);
        this._positiveCurve = new math_color/* Color4 */.ov(0, 0, 0, 0);
        this._negativeCurve = new math_color/* Color4 */.ov(0, 0, 0, 0);
        this._globalHue = 30;
     ...
     */
    clone() {
        return decorators_serialization/* SerializationHelper */.p.Clone(() => new ColorCurves(), this);
    }
    /**
     ...
     */
    static Parse(source) {
        return decorators_serialization/* SerializationHelper */.p.Parse(() => new ColorCurves(), source, null, null);
    }
}
/**
 * Prepare the list of uniforms associated with the ColorCurves effects.
...
decorators_serialization/* SerializationHelper */.p._ColorCurvesParser = ColorCurves.Parse;
...
class ImageProcessingConfiguration {
    constructor() {
         ...
         */
        this.vignetteColor = new math_color/* Color4 */.ov(0, 0, 0, 0);
        /**
         ...
         */
        this.onUpdateParameters = new observable/* Observable */.cP();
    }
    /**
    ...
    bind(effect, overrideAspectRatio) {
        ...
        if (this._vignetteEnabled || this._ditheringEnabled) {
            ...
            if (this._vignetteEnabled) {
                ...
                vignetteScaleX = (0,tools_functions/* Mix */.zF)(vignetteScaleX, vignetteScaleGeometricMean, this.vignetteStretch);
                vignetteScaleY = (0,tools_functions/* Mix */.zF)(vignetteScaleY, vignetteScaleGeometricMean, this.vignetteStretch);
     ...
     */
    clone() {
        return decorators_serialization/* SerializationHelper */.p.Clone(() => new ImageProcessingConfiguration(), this);
    }
    /**
     ...
     */
    static Parse(source) {
        const parsed = decorators_serialization/* SerializationHelper */.p.Parse(() => new ImageProcessingConfiguration(), source, null, null);
...
(0,tslib_es6/* __decorate */.Cg)([
    (0,decorators/* serializeAsColorCurves */.wL)()
...
(0,tslib_es6/* __decorate */.Cg)([
    (0,decorators/* serializeAsTexture */.uM)("colorGradingTexture")
...
(0,tslib_es6/* __decorate */.Cg)([
    (0,decorators/* serializeAsColor4 */.qK)()
...
// References the dependencies.
decorators_serialization/* SerializationHelper */.p._ImageProcessingConfigurationParser = ImageProcessingConfiguration.Parse;
// Register Class Name
(0,typeStore/* RegisterClass */.Y5)("BABYLON.ImageProcessingConfiguration", ImageProcessingConfiguration);
...
var pickingInfo = __webpack_require__(311);
...
var domManagement = __webpack_require__(8790);
...
class DeviceSource {
    ...
    deviceSlot = 0) {
         ...
         */
        this.onInputChangedObservable = new observable/* Observable */.cP();
...
class InputManager {
    ...
    _processPointerMove(pickResult, evt) {
        ...
        const type = evt.inputIndex >= PointerInput.MouseWheelX && evt.inputIndex <= PointerInput.MouseWheelZ ? pointerEvents/* PointerEventTypes */.Zp.POINTERWHEEL : pointerEvents/* PointerEventTypes */.Zp.POINTERMOVE;
    ...
    attachControl(attachUp = true, attachDown = true, attachMove = true, elementToAttachTo = null) {
        ...
        this._onPointerMove = (evt) => {
            ...
            if (this._checkPrePointerObservable(null, evt, evt.inputIndex >= PointerInput.MouseWheelX && evt.inputIndex <= PointerInput.MouseWheelZ ? pointerEvents/* PointerEventTypes */.Zp.POINTERWHEEL : pointerEvents/* PointerEventTypes */.Zp.POINTERMOVE)) {
                return;
            }
...
var perfCounter = __webpack_require__(4296);
// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Maths/math.color.js
var math_color = __webpack_require__(6041);
// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Maths/math.frustum.js
var math_frustum = __webpack_require__(2572);
...
var lightConstants = __webpack_require__(5515);
