...
#[link(name = "bullet")]
extern "C" {
    fn bw_create_generic6dofconstraint(body_a: *mut std::ffi::c_void, body_b: *mut std::ffi::c_void, frame_a: *const f32, frame_b: *const f32, use_linear_reference_frame_a: u8) -> *mut std::ffi::c_void;
    ...
    fn bw_create_generic6dofspringconstraint(body_a: *mut std::ffi::c_void, body_b: *mut std::ffi::c_void, frame_a: *const f32, frame_b: *const f32, use_linear_reference_frame_a: u8) -> *mut std::ffi::c_void;
...
impl Generic6DofConstraint {
    pub(crate) fn new(body_a: &mut RigidBody, body_b: &mut RigidBody, frame_a: &Mat4, frame_b: &Mat4, use_linear_reference_frame_a: bool) -> Self {
        let frame_a = frame_a.as_ref();
        let frame_b = frame_b.as_ref();
        
        Self {
            ptr: unsafe { bw_create_generic6dofconstraint(body_a.ptr_mut(), body_b.ptr_mut(), frame_a.as_ptr(), frame_b.as_ptr(), use_linear_reference_frame_a as u8) },
        }
    }
...
impl Generic6DofSpringConstraint {
    pub(crate) fn new(body_a: &mut RigidBody, body_b: &mut RigidBody, frame_a: &Mat4, frame_b: &Mat4, use_linear_reference_frame_a: bool) -> Self {
        ...
        Self {
            ptr: unsafe { bw_create_generic6dofspringconstraint(body_a.ptr_mut(), body_b.ptr_mut(), frame_a.as_ptr(), frame_b.as_ptr(), use_linear_reference_frame_a as u8) },
        }
    }
