"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[189],{
...
__webpack_require__.d(__webpack_exports__, {
  _IESTextureLoader: () => (/* binding */ _IESTextureLoader)
});
...
function interpolateCandelaValues(data, phi, theta) {
    ...
    const v1 = (0,math_scalar_functions/* Lerp */.cP)(data.candelaValues[thetaIndex][phiIndex], data.candelaValues[nextThetaIndex][phiIndex], t1);
    const v2 = (0,math_scalar_functions/* Lerp */.cP)(data.candelaValues[thetaIndex][phiIndex + 1], data.candelaValues[nextThetaIndex][phiIndex + 1], t1);
    const v = (0,math_scalar_functions/* Lerp */.cP)(v1, v2, t2);
    return v;
}
/**
