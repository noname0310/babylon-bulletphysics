"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[136,928],{
...
async function UploadLevelsAsync(texture, imageData, imageType = DefaultEnvironmentTextureImageType) {
    ...
    if (expandTexture) {
        if (engine.isWebGPU) {
            ...
            await __webpack_require__.e(/* import() */ 126).then(__webpack_require__.bind(__webpack_require__, 30371));
        }
        else {
...
class RGBDTextureTools {
    ...
    static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
        if (!scene.getEngine().isWebGPU) {
            await __webpack_require__.e(/* import() */ 71).then(__webpack_require__.bind(__webpack_require__, 32646));
        }
        else {
            await __webpack_require__.e(/* import() */ 126).then(__webpack_require__.bind(__webpack_require__, 85035));
        }
