"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[361],{
...
const ProcessAsync = async (texture, width, height, face, lod) => {
    ...
    if (!engine.isWebGPU) {
        if (texture.isCube) {
            await __webpack_require__.e(/* import() */ 71).then(__webpack_require__.bind(__webpack_require__, 92905));
        }
        else {
            await __webpack_require__.e(/* import() */ 71).then(__webpack_require__.bind(__webpack_require__, 19278));
        }
    }
    else {
        if (texture.isCube) {
            await __webpack_require__.e(/* import() */ 126).then(__webpack_require__.bind(__webpack_require__, 91650));
        }
        else {
...
class ThinPassPostProcess extends _Materials_effectRenderer_js__WEBPACK_IMPORTED_MODULE_0__/* .EffectWrapper */ .$ {
    _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
            ...
            list.push(Promise.all([__webpack_require__.e(/* import() */ 126).then(__webpack_require__.bind(__webpack_require__, 99965))]));
        }
        else {
            list.push(Promise.all([__webpack_require__.e(/* import() */ 71).then(__webpack_require__.bind(__webpack_require__, 79820))]));
        }
...
class ThinPassCubePostProcess extends _Materials_effectRenderer_js__WEBPACK_IMPORTED_MODULE_0__/* .EffectWrapper */ .$ {
    _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
            this._webGPUReady = true;
            list.push(Promise.all([__webpack_require__.e(/* import() */ 126).then(__webpack_require__.bind(__webpack_require__, 67682))]));
        }
        else {
