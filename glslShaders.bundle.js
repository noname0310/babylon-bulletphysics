...
/* harmony import */ var _sceneUboDeclaration_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8764);
/* harmony import */ var _meshUboDeclaration_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6467);
// Do not edit.
...
const decalFragmentDeclaration_name = "decalFragmentDeclaration";
const shader = `#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[decalFragmentDeclaration_name] = shader;
/** @internal */
const decalFragmentDeclaration = { name: decalFragmentDeclaration_name, shader };
...
const defaultFragmentDeclaration_shader = `uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[defaultFragmentDeclaration_name] = defaultFragmentDeclaration_shader;
/** @internal */
const defaultFragmentDeclaration = { name: defaultFragmentDeclaration_name, shader: defaultFragmentDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[prePassDeclaration_name] = prePassDeclaration_shader;
/** @internal */
const prePassDeclaration = { name: prePassDeclaration_name, shader: prePassDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[oitDeclaration_name] = oitDeclaration_shader;
/** @internal */
const oitDeclaration = { name: oitDeclaration_name, shader: oitDeclaration_shader };
...
var helperFunctions = __webpack_require__(3325);
;// ./node_modules/@babylonjs/core/Shaders/ShadersInclude/lightFragmentDeclaration.js
// Do not edit.

const lightFragmentDeclaration_name = "lightFragmentDeclaration";
const lightFragmentDeclaration_shader = `#ifdef LIGHT{X}
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[lightFragmentDeclaration_name] = lightFragmentDeclaration_shader;
/** @internal */
const lightFragmentDeclaration = { name: lightFragmentDeclaration_name, shader: lightFragmentDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[lightUboDeclaration_name] = lightUboDeclaration_shader;
/** @internal */
const lightUboDeclaration = { name: lightUboDeclaration_name, shader: lightUboDeclaration_shader };
...
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[lightsFragmentFunctions_name] = lightsFragmentFunctions_shader;
/** @internal */
const lightsFragmentFunctions = { name: lightsFragmentFunctions_name, shader: lightsFragmentFunctions_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[shadowsFragmentFunctions_name] = shadowsFragmentFunctions_shader;
/** @internal */
const shadowsFragmentFunctions = { name: shadowsFragmentFunctions_name, shader: shadowsFragmentFunctions_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[samplerFragmentDeclaration_name] = samplerFragmentDeclaration_shader;
/** @internal */
const samplerFragmentDeclaration = { name: samplerFragmentDeclaration_name, shader: samplerFragmentDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[fresnelFunction_name] = fresnelFunction_shader;
/** @internal */
const fresnelFunction = { name: fresnelFunction_name, shader: fresnelFunction_shader };
...
const reflectionFunction_shader = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[reflectionFunction_name] = reflectionFunction_shader;
/** @internal */
const reflectionFunction = { name: reflectionFunction_name, shader: reflectionFunction_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[imageProcessingDeclaration_name] = imageProcessingDeclaration_shader;
/** @internal */
const imageProcessingDeclaration = { name: imageProcessingDeclaration_name, shader: imageProcessingDeclaration_shader };
...
const imageProcessingFunctions_shader = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[imageProcessingFunctions_name] = imageProcessingFunctions_shader;
/** @internal */
const imageProcessingFunctions = { name: imageProcessingFunctions_name, shader: imageProcessingFunctions_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[bumpFragmentMainFunctions_name] = bumpFragmentMainFunctions_shader;
/** @internal */
const bumpFragmentMainFunctions = { name: bumpFragmentMainFunctions_name, shader: bumpFragmentMainFunctions_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[bumpFragmentFunctions_name] = bumpFragmentFunctions_shader;
/** @internal */
const bumpFragmentFunctions = { name: bumpFragmentFunctions_name, shader: bumpFragmentFunctions_shader };
...
var logDepthDeclaration = __webpack_require__(4581);
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[fogFragmentDeclaration_name] = fogFragmentDeclaration_shader;
/** @internal */
const fogFragmentDeclaration = { name: fogFragmentDeclaration_name, shader: fogFragmentDeclaration_shader };
...
const bumpFragment_shader = `vec2 uvOffset=vec2(0.0,0.0);
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[bumpFragment_name] = bumpFragment_shader;
/** @internal */
const bumpFragment = { name: bumpFragment_name, shader: bumpFragment_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[decalFragment_name] = decalFragment_shader;
/** @internal */
const decalFragment = { name: decalFragment_name, shader: decalFragment_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[depthPrePass_name] = depthPrePass_shader;
/** @internal */
const depthPrePass = { name: depthPrePass_name, shader: depthPrePass_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[lightFragment_name] = lightFragment_shader;
/** @internal */
const lightFragment = { name: lightFragment_name, shader: lightFragment_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[logDepthFragment_name] = logDepthFragment_shader;
/** @internal */
const logDepthFragment = { name: logDepthFragment_name, shader: logDepthFragment_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[fogFragment_name] = fogFragment_shader;
/** @internal */
const fogFragment = { name: fogFragment_name, shader: fogFragment_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[oitFragment_name] = oitFragment_shader;
/** @internal */
const oitFragment = { name: oitFragment_name, shader: oitFragment_shader };
...
const decalVertexDeclaration_name = "decalVertexDeclaration";
const shader = `#ifdef DECAL
uniform vec4 vDecalInfos;uniform mat4 decalMatrix;
#endif
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[decalVertexDeclaration_name] = shader;
/** @internal */
const decalVertexDeclaration = { name: decalVertexDeclaration_name, shader };
...
const defaultVertexDeclaration_shader = `uniform mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
uniform mat4 view;
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[defaultVertexDeclaration_name] = defaultVertexDeclaration_shader;
/** @internal */
const defaultVertexDeclaration = { name: defaultVertexDeclaration_name, shader: defaultVertexDeclaration_shader };
...
const uvAttributeDeclaration_shader = `#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[uvAttributeDeclaration_name] = uvAttributeDeclaration_shader;
/** @internal */
const uvAttributeDeclaration = { name: uvAttributeDeclaration_name, shader: uvAttributeDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[prePassVertexDeclaration_name] = prePassVertexDeclaration_shader;
/** @internal */
const prePassVertexDeclaration = { name: prePassVertexDeclaration_name, shader: prePassVertexDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[samplerVertexDeclaration_name] = samplerVertexDeclaration_shader;
/** @internal */
const samplerVertexDeclaration = { name: samplerVertexDeclaration_name, shader: samplerVertexDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[bumpVertexDeclaration_name] = bumpVertexDeclaration_shader;
/** @internal */
const bumpVertexDeclaration = { name: bumpVertexDeclaration_name, shader: bumpVertexDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[fogVertexDeclaration_name] = fogVertexDeclaration_shader;
/** @internal */
const fogVertexDeclaration = { name: fogVertexDeclaration_name, shader: fogVertexDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[lightVxFragmentDeclaration_name] = lightVxFragmentDeclaration_shader;
/** @internal */
const lightVxFragmentDeclaration = { name: lightVxFragmentDeclaration_name, shader: lightVxFragmentDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[lightVxUboDeclaration_name] = lightVxUboDeclaration_shader;
/** @internal */
const lightVxUboDeclaration = { name: lightVxUboDeclaration_name, shader: lightVxUboDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[prePassVertex_name] = prePassVertex_shader;
/** @internal */
const prePassVertex = { name: prePassVertex_name, shader: prePassVertex_shader };
...
const uvVariableDeclaration_shader = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[uvVariableDeclaration_name] = uvVariableDeclaration_shader;
/** @internal */
const uvVariableDeclaration = { name: uvVariableDeclaration_name, shader: uvVariableDeclaration_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[samplerVertexImplementation_name] = samplerVertexImplementation_shader;
/** @internal */
const samplerVertexImplementation = { name: samplerVertexImplementation_name, shader: samplerVertexImplementation_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[bumpVertex_name] = bumpVertex_shader;
/** @internal */
const bumpVertex = { name: bumpVertex_name, shader: bumpVertex_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[fogVertex_name] = fogVertex_shader;
/** @internal */
const fogVertex = { name: fogVertex_name, shader: fogVertex_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[shadowsVertex_name] = shadowsVertex_shader;
/** @internal */
const shadowsVertex = { name: shadowsVertex_name, shader: shadowsVertex_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[vertexColorMixing_name] = vertexColorMixing_shader;
/** @internal */
const vertexColorMixing = { name: vertexColorMixing_name, shader: vertexColorMixing_shader };
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[logDepthVertex_name] = logDepthVertex_shader;
/** @internal */
const logDepthVertex = { name: logDepthVertex_name, shader: logDepthVertex_shader };
...
var kernelBlurVaryingDeclaration = __webpack_require__(7382);
...
/* harmony export */ });
/* harmony import */ var _Engines_shaderStore_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9610);
/* harmony import */ var _ShadersInclude_helperFunctions_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3325);
// Do not edit.
...
const shadowMapFragment_shader = `float depthSM=vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
return;`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[shadowMapFragment_name] = shadowMapFragment_shader;
/** @internal */
const shadowMapFragment = { name: shadowMapFragment_name, shader: shadowMapFragment_shader };
...
var sceneUboDeclaration = __webpack_require__(8764);
// EXTERNAL MODULE: ./node_modules/@babylonjs/core/Shaders/ShadersInclude/meshUboDeclaration.js
var meshUboDeclaration = __webpack_require__(6467);
...
`;
// Sideeffect
shaderStore/* ShaderStore */.l.IncludesShadersStore[shadowMapVertexMetric_name] = shadowMapVertexMetric_shader;
/** @internal */
const shadowMapVertexMetric = { name: shadowMapVertexMetric_name, shader: shadowMapVertexMetric_shader };
