"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[318],{
...
__webpack_require__.d(__webpack_exports__, {
  _TGATextureLoader: () => (/* binding */ _TGATextureLoader)
});
...
function UploadContent(texture, data) {
    ...
    if (data.length < 19) {
        logger/* Logger */.V.Error("Unable to load TGA file - Not enough data to contain header");
        return;
    }
    // Read Header
    let offset = 18;
    ...
    if (header.id_length + offset > data.length) {
        logger/* Logger */.V.Error("Unable to load TGA file - Not enough data");
        return;
    }
