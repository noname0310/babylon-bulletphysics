"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[627],{
...
/* harmony import */ var _Runtime_constraint__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(67168);
...
/* harmony import */ var _Runtime_rigidBodyBundle__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(67648);
/* harmony import */ var _Runtime_rigidBodyConstructionInfo__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(35901);
/* harmony import */ var _Runtime_rigidBodyConstructionInfoList__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(3477);
/* harmony import */ var _Util_benchHelper__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(89800);
...
class SceneBuilder {
    async build(_canvas, engine) {
        ...
        const wasmInstance = await (0,_Runtime_bulletWasmInstance__WEBPACK_IMPORTED_MODULE_14__/* .getBulletWasmInstance */ .e)(new _Runtime_InstanceType_multiRelease__WEBPACK_IMPORTED_MODULE_15__/* .BulletWasmInstanceTypeMR */ .t(), threadCount);
        ...
        for (let i = 0; i < rowCount; ++i)
            for (let j = 0; j < columnCount; ++j) {
                ...
                const rbInfoList = new _Runtime_rigidBodyConstructionInfoList__WEBPACK_IMPORTED_MODULE_22__/* .RigidBodyConstructionInfoList */ .x(wasmInstance, rbCount);
