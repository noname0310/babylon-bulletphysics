"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[7136,9928],{
...
/* harmony import */ var _Misc_HighDynamicRange_cubemapToSphericalPolynomial_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36755);
/* harmony import */ var _baseTexture_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(56526);


_baseTexture_js__WEBPACK_IMPORTED_MODULE_1__/* .BaseTexture */ .t.prototype.forceSphericalPolynomialsRecompute = function () {
    if (this._texture) {
...
Object.defineProperty(_baseTexture_js__WEBPACK_IMPORTED_MODULE_1__/* .BaseTexture */ .t.prototype, "sphericalPolynomial", {
    get: function () {
        if (this._texture) {
            ...
            if (this._texture.isReady) {
                if (!this._texture._sphericalPolynomialPromise) {
                    this._texture._sphericalPolynomialPromise = _Misc_HighDynamicRange_cubemapToSphericalPolynomial_js__WEBPACK_IMPORTED_MODULE_0__/* .CubeMapToSphericalPolynomialTools */ .d.ConvertCubeMapTextureToSphericalPolynomial(this);
    ...
    if (!_enginePromise) {
        _enginePromise = new Promise((resolve, reject) => {
            ...
            Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 86514))
                ...
                __webpack_require__.e(/* import() */ 9071).then(__webpack_require__.bind(__webpack_require__, 79820)).then(({ passPixelShader }) => {
                    if (!engine) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $h: () => (/* binding */ CreateImageDataArrayBufferViews),
/* harmony export */   cU: () => (/* binding */ GetEnvInfo),
/* harmony export */   gW: () => (/* binding */ _UpdateRGBDAsync),
/* harmony export */   o5: () => (/* binding */ UploadEnvLevelsAsync),
/* harmony export */   ow: () => (/* binding */ UploadEnvSpherical)
/* harmony export */ });
/* unused harmony exports normalizeEnvInfo, CreateEnvTextureAsync, UploadLevelsAsync, EnvironmentTextureTools */
/* harmony import */ var _tools_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(998);
/* harmony import */ var _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(79923);
/* harmony import */ var _Maths_math_scalar_functions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(84867);
/* harmony import */ var _Maths_sphericalPolynomial_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(77517);
/* harmony import */ var _Materials_Textures_internalTexture_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(81194);
/* harmony import */ var _Materials_Textures_baseTexture_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(56526);
/* harmony import */ var _scene_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(87491);
/* harmony import */ var _PostProcesses_postProcess_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(77891);
/* harmony import */ var _Misc_logger_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(51137);
/* harmony import */ var _rgbdTextureTools_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(97126);
/* harmony import */ var _Materials_Textures_baseTexture_polynomial_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(69764);
/* harmony import */ var _Misc_dumpTools_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(89928);
...
function GetEnvInfo(data) {
    ...
    for (let i = 0; i < MagicBytes.length; i++) {
        if (dataView.getUint8(pos++) !== MagicBytes[i]) {
            _Misc_logger_js__WEBPACK_IMPORTED_MODULE_8__/* .Logger */ .V.Error("Not a babylon environment map");
            return null;
        }
    }
...
async function CreateEnvTextureAsync(texture, options = {}) {
    ...
    const hostingScene = new _scene_js__WEBPACK_IMPORTED_MODULE_6__/* .Scene */ .Z(engine);
    ...
    for (let i = 0; i <= mipmapsCount; i++) {
        ...
        for (let face = 0; face < 6; face++) {
            ...
            await _rgbdTextureTools_js__WEBPACK_IMPORTED_MODULE_9__/* .RGBDTextureTools */ .G.EncodeTextureToRGBD(tempTexture, hostingScene, textureType);
            const rgbdEncodedData = await engine._readTexturePixels(tempTexture, faceWidth, faceWidth);
            const imageEncodedData = await (0,_Misc_dumpTools_js__WEBPACK_IMPORTED_MODULE_11__.DumpDataAsync)(faceWidth, faceWidth, rgbdEncodedData, imageType, undefined, false, true, options.imageQuality);
...
async function UploadLevelsAsync(texture, imageData, imageType = DefaultEnvironmentTextureImageType) {
    if (!_tools_js__WEBPACK_IMPORTED_MODULE_0__/* .Tools */ .S0.IsExponentOfTwo(texture.width)) {
    ...
    if (expandTexture) {
        if (engine.isWebGPU) {
            ...
            await __webpack_require__.e(/* import() */ 3126).then(__webpack_require__.bind(__webpack_require__, 30371));
        }
        else {
            await __webpack_require__.e(/* import() */ 9071).then(__webpack_require__.bind(__webpack_require__, 9682));
        }
        // Simply run through the decode PP
        rgbdPostProcess = new _PostProcesses_postProcess_js__WEBPACK_IMPORTED_MODULE_7__/* .PostProcess */ .w("rgbdDecode", "rgbdDecode", null, null, 1, null, 3, engine, false, undefined, texture.type, undefined, null, false, undefined, shaderLanguage);
        ...
        if (generateNonLODTextures) {
            ...
            for (let i = 0; i < mipSlices; i++) {
                ...
                const glTextureFromLod = new _Materials_Textures_internalTexture_js__WEBPACK_IMPORTED_MODULE_4__/* .InternalTexture */ .hV(engine, 2 /* InternalTextureSource.Temp */);
                glTextureFromLod.isCube = true;
                glTextureFromLod.invertY = true;
                glTextureFromLod.generateMipMaps = false;
                engine.updateTextureSamplingMode(2, glTextureFromLod);
                // Wrap in a base texture for easy binding.
                const lodTexture = new _Materials_Textures_baseTexture_js__WEBPACK_IMPORTED_MODULE_5__/* .BaseTexture */ .t(null);
...
function UploadEnvSpherical(texture, info) {
    ...
    const sp = new _Maths_sphericalPolynomial_js__WEBPACK_IMPORTED_MODULE_3__/* .SphericalPolynomial */ .Q();
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.x, 0, sp.x);
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.y, 0, sp.y);
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.z, 0, sp.z);
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.xx, 0, sp.xx);
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.yy, 0, sp.yy);
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.zz, 0, sp.zz);
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.yz, 0, sp.yz);
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.zx, 0, sp.zx);
    _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.FromArrayToRef(irradianceInfo.xy, 0, sp.xy);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   G: () => (/* binding */ RGBDTextureTools)
/* harmony export */ });
/* harmony import */ var _PostProcesses_postProcess_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(77891);
/* harmony import */ var _textureTools_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(42683);
...
class RGBDTextureTools {
    ...
    static ExpandRGBDTexture(texture) {
        ...
        const expandRGBDTexture = async () => {
            ...
            // Expand the texture if possible
            // Simply run through the decode PP.
            const rgbdPostProcess = new _PostProcesses_postProcess_js__WEBPACK_IMPORTED_MODULE_0__/* .PostProcess */ .w("rgbdDecode", "rgbdDecode", null, null, 1, null, 3, engine, false, undefined, internalTexture.type, undefined, null, false, undefined, shaderLanguage);
            rgbdPostProcess.externalTextureSamplerBinding = true;
    ...
    static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
        if (!scene.getEngine().isWebGPU) {
            await __webpack_require__.e(/* import() */ 9071).then(__webpack_require__.bind(__webpack_require__, 32646));
        }
        else {
            await __webpack_require__.e(/* import() */ 3126).then(__webpack_require__.bind(__webpack_require__, 85035));
        }
        return (0,_textureTools_js__WEBPACK_IMPORTED_MODULE_1__/* .ApplyPostProcess */ .Qs)("rgbdEncode", internalTexture, scene, outputTextureType, 1, 5);
    }
}
