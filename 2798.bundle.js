"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[2798],{
...
/* harmony export */ });
/* harmony import */ var _dataBuffer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(71504);
/* harmony import */ var _Misc_logger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(51137);
/* harmony import */ var _bufferUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11675);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Lm: () => (/* binding */ AreIndices32Bits),
...
/* harmony import */ var _Materials_Textures_texture_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7481);
/* harmony import */ var _PostProcesses_postProcessManager_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(36096);
/* harmony import */ var _Misc_tools_functions_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(91597);
/* harmony import */ var _effect_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(74420);
/* harmony import */ var _Misc_logger_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(51137);
/* harmony import */ var _Rendering_objectRenderer_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(81283);
 ...
 */
_effect_js__WEBPACK_IMPORTED_MODULE_5__/* .Effect */ .M.prototype.setDepthStencilTexture = function (channel, texture) {
...
class RenderTargetTexture extends _Materials_Textures_texture_js__WEBPACK_IMPORTED_MODULE_2__/* .Texture */ .g {
    ...
    constructor(name, size, scene, generateMipMaps = false, doNotChangeAspectRatio = true, type = 0, isCube = false, samplingMode = _Materials_Textures_texture_js__WEBPACK_IMPORTED_MODULE_2__/* .Texture */ .g.TRILINEAR_SAMPLINGMODE, generateDepthBuffer = true, generateStencilBuffer = false, isMulti = false, format = 5, delayAllocation = false, samples, creationFlags, noColorAttachment = false, useSRGBBuffer = false) {
        ...
        this._objectRenderer =
            existingObjectRenderer ??
                new _Rendering_objectRenderer_js__WEBPACK_IMPORTED_MODULE_7__/* .ObjectRenderer */ .P(name, scene, {
        ...
        this._onAfterRenderingManagerRenderObserver = this._objectRenderer.onAfterRenderingManagerRenderObservable.add(() => {
            ...
            if (this._currentDumpForDebug) {
                if (!this._dumpTools) {
                    _Misc_logger_js__WEBPACK_IMPORTED_MODULE_6__/* .Logger */ .V.Error("dumpTools module is still being loaded. To speed up the process import dump tools directly in your project");
                }
                else {
    ...
    isReadyForRendering() {
        if (!this._dumpToolsLoading) {
            ...
            Promise.all(/* import() */[__webpack_require__.e(998), __webpack_require__.e(9928)]).then(__webpack_require__.bind(__webpack_require__, 89928)).then((module) => (this._dumpTools = module));
        }
    ...
    _bestReflectionRenderTargetDimension(renderDimension, scale) {
        ...
        const curved = (0,_Misc_tools_functions_js__WEBPACK_IMPORTED_MODULE_4__/* .NearestPOT */ .OG)(x + (minimum * minimum) / (minimum + x));
        // Ensure we don't exceed the render dimension (while staying POT)
        return Math.min((0,_Misc_tools_functions_js__WEBPACK_IMPORTED_MODULE_4__/* .FloorPOT */ .C4)(renderDimension), curved);
    }
    /**
     * @internal
 ...
 */
RenderTargetTexture.REFRESHRATE_RENDER_ONCE = _Rendering_objectRenderer_js__WEBPACK_IMPORTED_MODULE_7__/* .ObjectRenderer */ .P.REFRESHRATE_RENDER_ONCE;
/**
 * The texture will be rendered every frame and is recommended for dynamic contents.
 */
RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYFRAME = _Rendering_objectRenderer_js__WEBPACK_IMPORTED_MODULE_7__/* .ObjectRenderer */ .P.REFRESHRATE_RENDER_ONEVERYFRAME;
/**
 * The texture will be rendered every 2 frames which could be enough if your dynamic objects are not
 * the central point of your effect and can save a lot of performances.
 */
RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYTWOFRAMES = _Rendering_objectRenderer_js__WEBPACK_IMPORTED_MODULE_7__/* .ObjectRenderer */ .P.REFRESHRATE_RENDER_ONEVERYTWOFRAMES;
...
/* harmony export */ });
/* harmony import */ var _Buffers_buffer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95616);
/* harmony import */ var _Maths_math_viewport_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(54494);
/* harmony import */ var _Misc_observable_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(99848);
/* harmony import */ var _effect_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74420);
/* harmony import */ var _drawWrapper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35476);
/* harmony import */ var _Shaders_postprocess_vertex_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16612);
...
class EffectWrapper {
    ...
    _gatherImports(useWebGPU = false, list) {
        ...
        if (useWebGPU && this._webGPUReady) {
            list.push(Promise.all([__webpack_require__.e(/* import() */ 3126).then(__webpack_require__.bind(__webpack_require__, 32083))]));
        }
        else {
            list.push(Promise.all([Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 16612))]));
        }
    }
    /** @internal */
...
/* harmony import */ var _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17931);
/* harmony import */ var _Misc_observable_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(99848);
/* harmony import */ var _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(79923);
/* harmony import */ var _Materials_effect_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(74420);
/* harmony import */ var _Misc_decorators_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(79259);
/* harmony import */ var _Misc_decorators_serialization_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26877);
/* harmony import */ var _Misc_typeStore_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(56552);
/* harmony import */ var _Engines_abstractEngine_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(32206);
/* harmony import */ var _Misc_tools_functions_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(91597);
/* harmony import */ var _Materials_effectRenderer_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(84255);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   P: () => (/* binding */ ObjectRenderer)
/* harmony export */ });
/* harmony import */ var _Misc_observable_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99848);
/* harmony import */ var _Rendering_renderingManager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15808);
/* harmony import */ var _Misc_arrayTools_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(27309);
...
class ObjectRenderer {
    ...
    set renderList(value) {
        ...
        if (value) {
            this._unObserveRenderList = (0,_Misc_arrayTools_js__WEBPACK_IMPORTED_MODULE_2__/* ._ObserveArray */ .lL)(value, this._renderListHasChanged);
        }
    ...
    constructor(name, scene, options) {
         ...
         */
        this.onBeforeRenderingManagerRenderObservable = new _Misc_observable_js__WEBPACK_IMPORTED_MODULE_0__/* .Observable */ .cP();
        /**
         * An event triggered after the rendering group is processed
         */
        this.onAfterRenderingManagerRenderObservable = new _Misc_observable_js__WEBPACK_IMPORTED_MODULE_0__/* .Observable */ .cP();
        /**
         * An event triggered when fast path rendering is used
         */
        this.onFastPathRenderObservable = new _Misc_observable_js__WEBPACK_IMPORTED_MODULE_0__/* .Observable */ .cP();
        ...
        // Rendering groups
        this._renderingManager = new _Rendering_renderingManager_js__WEBPACK_IMPORTED_MODULE_1__/* .RenderingManager */ .m(scene);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   U: () => (/* binding */ RenderingGroup)
/* harmony export */ });
/* harmony import */ var _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17931);
/* harmony import */ var _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(79923);
...
class RenderingGroup {
    ...
    constructor(index, scene, opaqueSortCompareFn = null, alphaTestSortCompareFn = null, transparentSortCompareFn = null) {
        this.index = index;
        this._opaqueSubMeshes = new _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_0__/* .SmartArray */ .L(256);
        this._transparentSubMeshes = new _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_0__/* .SmartArray */ .L(256);
        this._alphaTestSubMeshes = new _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_0__/* .SmartArray */ .L(256);
        this._depthOnlySubMeshes = new _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_0__/* .SmartArray */ .L(256);
        this._particleSystems = new _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_0__/* .SmartArray */ .L(256);
        this._spriteManagers = new _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_0__/* .SmartArray */ .L(256);
        /** @internal */
        this._empty = true;
        /** @internal */
        this._edgesRenderers = new _Misc_smartArray_js__WEBPACK_IMPORTED_MODULE_0__/* .SmartArrayNoDuplicate */ .b(16);
        this._scene = scene;
    ...
    static _RenderSorted(subMeshes, sortCompareFn, camera, transparent) {
        ...
        if (transparent) {
            for (; subIndex < subMeshes.length; subIndex++) {
                ...
                subMesh._distanceToCamera = _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.Distance(subMesh.getBoundingInfo().boundingSphere.centerWorld, cameraPosition);
            }
        }
...
RenderingGroup._ZeroVector = _Maths_math_vector_js__WEBPACK_IMPORTED_MODULE_1__/* .Vector3 */ .Pq.Zero();
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   m: () => (/* binding */ RenderingManager)
/* harmony export */ });
/* unused harmony export RenderingGroupInfo */
/* harmony import */ var _renderingGroup_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11628);
...
class RenderingManager {
    ...
    _prepareRenderingGroup(renderingGroupId) {
        if (this._renderingGroups[renderingGroupId] === undefined) {
            this._renderingGroups[renderingGroupId] = new _renderingGroup_js__WEBPACK_IMPORTED_MODULE_0__/* .RenderingGroup */ .U(renderingGroupId, this._scene, this._customOpaqueSortCompareFn[renderingGroupId], this._customAlphaTestSortCompareFn[renderingGroupId], this._customTransparentSortCompareFn[renderingGroupId]);
        }
    }
    /**
