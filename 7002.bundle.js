"use strict";
(self["webpackChunkbabylon_bulletphysics"] = self["webpackChunkbabylon_bulletphysics"] || []).push([[7002],{
  ...
  _workers = await Promise.all(
    Array.from({ length: builder.numThreads() }, async () => {
      ...
      const worker = new Worker(
        new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(7909), __webpack_require__.b),
        {
          type: undefined
        }
      );
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL(/* asset import */ __webpack_require__(79845), __webpack_require__.b);
    }
    const imports = __wbg_get_imports();
...
module.exports = __webpack_require__.p + "efc108f2715161cd0d47.wasm";
